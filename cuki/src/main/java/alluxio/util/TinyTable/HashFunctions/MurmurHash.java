package alluxio.util.TinyTable.HashFunctions;
...
public class MurmurHash {
	 ...
	 * features. Since java code is interpreted, we modified the function hash64 
	 * to use bitwise operations as much as possible. It was not needed in the C version
	 * as most modern compilers can do it.
	 * 
	 * Public domain.
	 * 
	 * 
	 * 
	 * @author Viliam Holub, modified by Gil Einziger
	 * 
	 */
	public final static class ModifiedMurmurHash {
		 ...
		 * Modified to be slightly more efficient by using bitwise operations as much as possible. 
		 * 
		 * @param data
		 *            byte array to hash
		 * @param length
