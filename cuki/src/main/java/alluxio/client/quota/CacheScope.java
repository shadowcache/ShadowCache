...
/**
 * This class defines "Scope" of a cache quota. For Presto caching, scope is hierarchical with
...
public class CacheScope {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equal(mId.substring(0, mLength),
        cacheScope.mId.substring(0, cacheScope.mLength));
  }
   ...
   */
  public enum Level {
    GLOBAL("\\."), SCHEMA("\\w+"), TABLE("\\w+\\.\\w+"), PARTITION("\\w+\\.\\w+.\\w+");
