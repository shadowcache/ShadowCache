...
public class SequentialIntegerEntryGenerator implements EntryGenerator<Integer> {
  ...
  private static final int DEFAULT_SEED = 32713;
  ...
  public SequentialIntegerEntryGenerator(long numEntries) {
    this(numEntries, DEFAULT_LOWER_BOUND, DEFAULT_UPPER_BOUND, DEFAULT_LOWER_BOUND_SIZE,
        DEFAULT_UPPER_BOUND_SIZE, DEFAULT_NUM_SCOPES);
  }

  public SequentialIntegerEntryGenerator(long numEntries, int lowerBound, int upperBound) {
