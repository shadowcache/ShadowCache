...
public class SimpleBitSetTest {
  ...
  public void basicTest() {
    BitSet bitSet = new SimpleBitSet(100);
    bitSet.set(9);
  ...
  public void overlapTest() {
    BitSet bitSet = new SimpleBitSet(128);
    bitSet.set(0, 12, 0xFFFL);
    bitSet.set(12, 20, 0x0L);
    bitSet.set(32, 32, INT_MASK);
    assertEquals(0xFFFL, bitSet.get(0, 12));
    assertEquals(0x0L, bitSet.get(12, 20));
    assertEquals(INT_MASK, bitSet.get(32, 32));
    assertEquals(0x0L, bitSet.get(64, 128));
  }
